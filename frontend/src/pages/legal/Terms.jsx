      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="rounded-xl p-8 space-y-6" style={{ background: 'var(--surface)', border: '1px solid rgba(201,168,76,0.15)' }}>
            ...
            {[
              { title: '1. Authorized Personnel Only', body: 'CounselFlow is a restricted system for authorized law firm staff. Access credentials are personal and non-transferable. All activity is logged and attributed to the authenticated user.' },
              ...
              { title: '6. Modifications', body: 'These terms may be updated periodically. Continued use of CounselFlow constitutes acceptance of any revised terms.' },
            ].map(({ title, body }) => (
              <div key={title}>
