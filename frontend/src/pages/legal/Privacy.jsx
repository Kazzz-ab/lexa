      ...
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="rounded-xl p-8 space-y-6" style={{ background: 'var(--surface)', border: '1px solid rgba(201,168,76,0.15)' }}>
            <p style={{ fontFamily: 'var(--font-body)', color: 'var(--muted)', fontSize: '0.85rem', fontStyle: 'italic' }}>Last updated: June 2026</p>
            {[
              { title: '1. Information We Collect', body: 'CounselFlow collects client personal information, case details, billing records, and attorney credentials necessary for law firm operations. All data is stored securely in encrypted PostgreSQL databases.' },
              { title: '2. Attorney-Client Privilege', body: 'All client communications and case information entered into CounselFlow is subject to attorney-client privilege. The system is designed to maintain confidentiality in accordance with applicable bar rules and professional ethics standards.' },
